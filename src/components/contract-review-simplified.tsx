...
export default function ContractReviewSimplified() {
  ...
  return (
    <div className={file ? "h-screen bg-gray-50 flex flex-col overflow-hidden" : "min-h-screen bg-gray-50"}>
      <div className={`${file ? 'flex-1 flex flex-col min-h-0' : 'max-w-7xl mx-auto'} ${file ? 'p-0' : 'p-6'}`}>
